...
class Embedscommands(commands.Cog):
	...
	async def media_roles_subcommand(self, ctx):
		await ctx.message.delete()
		emb = discord.Embed(title = 'Медиа пространство', description='\n<@&745619648015368232>\n **``Можно получить при достижении  5.000 подписчиков на YouTube. Выделяется среди других участников, имеет собственную голосовую комнату, доступ во все комнаты в соответствующей категории. Также возможность перемещать участников между комнатами``**\n \n <@&745619537067507773>\n**``Можно получить при достижении  5.000 подписчиков на YouTube. Выделяется среди других участников, имеет собственную голосовую комнату, доступ во все комнаты в соответствующей категории``**\n \n <@&745617026726232114>\n**``Можно получить при достижении 1.000 подписчиков на YouTube. Имеет возможность создать свою голосовую комнату``**',colour=0xFFC700)
		await ctx.send(embed=emb)
#Add cog files
def setup(bot):
